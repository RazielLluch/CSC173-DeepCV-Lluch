...
# Side-view specific risk mapping
SIDE_VIEW_RISK_MAPPING = {
    # Forward lean (most visible in side-view)
    ("forwardbadposture", "any"): "high",
    
    # Good posture
    ("goodposture", "any"): "low",
    
    # Reclined (also visible in side-view)
    ("backwardbadposture", "any"): "medium",
}

# Feature importance weights (for interpretation)
SIDE_VIEW_FEATURE_WEIGHTS = {
    'head_forward': 0.35,      # Most important in side-view
    'spine_angle': 0.35,       # Equally important
    'upper_back_curve': 0.15,  # Secondary
    'shoulder_position': 0.10, # Tertiary
    'elbow_position': 0.05,    # Least important (often occluded)
}